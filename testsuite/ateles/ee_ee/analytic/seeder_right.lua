 ...
 spatial_object = {
  ...
  { attribute = {
    ...
    geometry = {
      kind = 'canoND',
      object = {
        origin = { (-eps), (-2.0-eps), elemSize+eps }, -- left down front 
  ...
  { attribute = {
    ...
    geometry = {
      kind = 'canoND',
      object = {
        origin = { (-eps), (-2.0-eps), -eps }, -- left down back
        vec = { { (2.0+2*eps), 0.0, 0.0 },
                { 0.0, (4.0+2*eps), 0.0 },
        },
      } -- object
  ...
  { attribute = {
    ...
    geometry = {
      kind = 'canoND',
      object = {
        origin = { (-eps), (-2.0-eps), -eps }, -- left, down, front
  ...
  { attribute = {
    ...
    geometry = {
      kind = 'canoND',
      object = {
        origin = {(-eps), (2.0+eps), -eps }, -- left, up, front
        vec = { { (2.0+2*eps), 0.0, 0.0 },
